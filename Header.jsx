  ...
  return (
    <nav {...props}>
      ...
      dark:border-white/10 dark:bg-zinc-900/30 dark:shadow-white/5 dark:ring-white/10 dark:hover:bg-zinc-900/40"
          >
         <NavItem href="https://www.dropbox.com/scl/fo/urxctlscz4oyclalskf7f/AC5QlIhqblhtZvVf4WcYQ2g?rlkey=0y7xj176b04bw5nr3omrf4z26&st=3id8qmki&dl=0">All Notes Archive</NavItem>
        <NavItem href="https://www.dropbox.com/scl/fo/urxctlscz4oyclalskf7f/AC5QlIhqblhtZvVf4WcYQ2g?rlkey=0y7xj176b04bw5nr3omrf4z26&st=3id8qmki&dl=0">Notes Upload</NavItem>
              <NavItem href="communilink">Important Links</NavItem>
              <NavItem href="https://gemini.google.com/app">Gemini AI</NavItem>
        <NavItem_External href="about">
          about NoteHub
        </NavItem_External>
      </ul>
    </nav>
